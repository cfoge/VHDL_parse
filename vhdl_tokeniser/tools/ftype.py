...
if __name__ == "__main__":
    ...
    parser.add_argument('-v', '--verbose', action='store_true', help='Print verbose output (prints the next few lines after it finds a match)')
    ...
    print(f"Searching for {search_type} with '{search_term}' in directory: {directory}...")
