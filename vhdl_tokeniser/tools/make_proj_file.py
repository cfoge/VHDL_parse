...
parsed_file_jason = "" # location of the parsed files in JSON format (can i do without a lib?)
...
# getting info on a project
    ...
    print("*****************************")
    print(f"Project '{project_obj[0]}', created {project_obj[3]} with root directory '{project_obj[1]}' ")
