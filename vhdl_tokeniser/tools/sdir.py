...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Print directory tree structure with optional features.")
    parser.add_argument("directory", type=str, help="Directory to print the tree structure of.")
    parser.add_argument("-color", action="store_true", help="Enable colorized output.")
    parser.add_argument("-find", type=str, help="String to find in filenames and folder names.")
