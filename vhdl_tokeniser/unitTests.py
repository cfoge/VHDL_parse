...
class TestReplaceEndProcessTokens(unittest.TestCase):
    ...
    ###################################################
    def test_find_next_ident_working(
        self,
    ...
    def test_find_next_ident_working_2(
        self,
    ):  # tokens is global need to find a way to test this
        tokens = [
    ...
    def test_find_prev_ident_working(
        self,
    ):  # tokens is global need to find a way to test this
        tokens = [
            ("IdentifierToken", "a"),
    ...
    def test_find_prev_ident_working_2(
        self,
    ):  # tokens is global need to find a way to test this
        tokens = [
            ("IdentifierToken", "A"),
    ...
    ###################################################### find_prev_till()
    def test_find_prev_till_single(
        self,
    ):  # tokens is global need to find a way to test this
        tokens = [
            ("EntityKeyword", "entity"),
