...
def custom_test_suite_full(file_name, expected_result):
    ...
    suite.addTest(
        TestParseVHDLDecoding(
            "test_data_return_correct",
            file_name=file_name,
    ...
    suite.addTest(
        TestParseVHDLDecoding(
            "test_lib_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_lib_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_port_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_port_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_signal_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_signal_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_assign_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_assign_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_arch_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_arch_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_constant_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_constant_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    ...
    suite.addTest(
        TestParseVHDLDecoding(
            "test_subtype_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_subtype_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_type_dec_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_type_dec_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_nonSynth_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_nonSynth_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_func_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_func_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_generate_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_generate_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_generic_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_generic_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_process_return_length_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
    suite.addTest(
        TestParseVHDLDecoding(
            "test_process_return_content_correct",
            file_name=file_name,
            expected_result=expected_result,
        )
    )
...
if __name__ == "__main__":
    ...
    expected_result_main2 = [
        "comparator",
        2,
        ["ieee", "ieee.std_logic_1164.all"],  # lib
        5,
        [
    ...
    expected_result_main3 = [
        "traffic_light_controller",
        3,
        ["ieee", "ieee.std_logic_1164.all", "ieee.std_logic_unsigned.all"],  # lib
        5,
        [
            ["sensor", "in", "std_logic", 1, None],
            ["clk", "in", "std_logic", 1, None],
            ["rst_n", "in", "std_logic", 1, None],
            ["light_highway", "out", "std_logic_vector", 3, None],
            ["light_farm", "out", "std_logic_vector", 3, None],
        ],  # port
        None,
        ["dont use this"],  # sig not used
        ####
        11,
        [
            ["ab(0)", "(not a(0)) xnor (not b(0))"],
