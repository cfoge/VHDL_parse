...
for i in vhd:
    ...
    if ("entity" in i) & ("Insert File path" in i):
        tmp1 = i.strip()
    ...
    if ("process" in i) & ("Insert File path" in i) & ("Insert File path" in i):
        tmp1 = i.strip()
        process_vhdl.append(vhdl_obj("process", tmp1, vhd.index(i)))
    if ("constant" in i) & ("Insert File path" in i) & ("Insert File path" in i):
        tmp1 = i.strip()
        constant_vhdl.append(tmp1)
    if ("Variable" in i) & ("Insert File path" in i) & ("Insert File path" in i):
        tmp1 = i.strip()
        variable_vhdl.append(tmp1)
    if ("attribute" in i) & ("Insert File path" in i) & ("Insert File path" in i):
        tmp1 = i.strip()
        attribute_vhdl.append(tmp1)
    if (("signal" in i) & ("Insert File path" in i) & ("Insert File path" in i)) & ("attribute" not in i):
        tmp1 = i.strip()
